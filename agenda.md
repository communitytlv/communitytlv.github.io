...
<div class="box" style="background-color: black;">
	...
	<div><h3><span style="color: turquoise">BREAK</span></h3></div>
     <div class="box">
    <div><h4 style="text-transform: uppercase;">SPONSOR TALK: COUCHBASE</h4></div>
     </div>
</div>
...
<div class="box" style="background-color: black;">
	...
	<div><h3><span style="color: turquoise">BREAK</span></h3></div>
     <div class="box">
    <div><h4 style="text-transform: uppercase;">SPONSOR TALK</h4></div>
    </div>
</div>
...
<div class="box" style="background-color: #2a2f4a;" >
	...
	<span style="color: turquoise"> // NOAM ROTEM</span></h3></div>   
        ...
        <h4 style="text-transform: uppercase;">Good code, bad OPSEC - Data horror stories from a hacker's perspective
		<span style="color: #8d82c4; text-transform: uppercase;">// Noam Rotem</span></h4>
