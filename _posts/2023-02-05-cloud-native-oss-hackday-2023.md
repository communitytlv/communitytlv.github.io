...
<section id="one">
	<div class="inner">
		<header class="major">
			<h1 style="color: turquoise; text-transform: uppercase;"><span class="icon alt fa-anchor"></span> EVENT CANCELLED </h1> 
...
<li>POSTPONED - MAY - HACK DAY!</li>
<li>POSTPONED - MAY - Final Demos and Happy Hour</li>
</ul>
